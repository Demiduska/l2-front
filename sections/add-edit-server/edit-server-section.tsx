...
import { ServerResponseType, ServerTagType } from "../../utils/api/types";
import { Step1EditServer } from "../../components/step/Step1EditServer";

import styles from "./AddServerSection.module.scss";
import { Step2EditServer } from "../../components/step/Step2EditServer";
...
export const EditServerSection: FC = () => {
